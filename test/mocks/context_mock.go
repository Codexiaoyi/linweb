...
func (m *MockIContext) New(arg0 http.ResponseWriter, arg1 *http.Request, arg2 interfaces.IMiddleware) interfaces.IContext {
	m.ctrl.T.Helper()
...
func (mr *MockIContextMockRecorder) New(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "New", reflect.TypeOf((*MockIContext)(nil).New), arg0, arg1, arg2)
}
